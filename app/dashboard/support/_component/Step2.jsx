...
export default function ConfirmDetails() {
  ...
  return (
    ...
    <div className="min-h-screen shadow-md w-full max-w-[60rem] mx-auto p-4 bg-white">
  {/* Header */}
  <div className="border-b">
    <div className="px-4 py-2">
      <Link href={"/dashboard/support/step1"}>
        <Button variant="ghost" className="text-teal-800 gap-2">
          <ChevronLeft className="h-4 w-4" />
          Back
        </Button>
      </Link>
  ...
  <div className="flex flex-col lg:flex-row">
    {/* Sidebar */}
    <div className="w-full lg:w-96 border-b lg:border-r p-6">
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          <Avatar className="h-16 w-16">
            <img src="/placeholder.svg" alt="Profile" />
