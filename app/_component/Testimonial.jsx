...
const testimonials = [
  {
    id: 1,
    content: "ScholarMetis has helped in a lot of ways but more importantly it has helped scale through in topics from Physics and Chemistry that I've thought i could not understand. The guidance and personalized AI assistance learning is also top notch. Overall it's a platform i will recommend any day.",
  ...
  return (
   <div className='bg-[#F2FDFF]'>
     <div className="w-full max-w-7xl mx-auto px-4 py-16">
      <h2 className="text-4xl font-bold text-center mb-12">What people are saying about ScholaMetis</h2>
