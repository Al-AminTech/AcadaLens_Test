...
function HeroSec() {
  return (
    <div className='flex flex-col md:flex-row  gap-7 md:justify-around mt-10'>
        <div>
            <h3 className=' text-[30px] md:text-[40px] md:w-[421px] w-full font-bold text-center md:text-start text-[#0091b2d8]'><span className='text-[#005C73]'>Best Platform</span> Where You Can Dive Into Greatness of <span className='text-[#005C73]  italic text-end'>Learning</span></h3>
